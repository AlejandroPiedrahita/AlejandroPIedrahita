<div align="center">
  ...
  <h1>👋 ¡Hola! Soy Alejandro Piedrahita</h1>
...
- 🎓 **Ingeniero de Software**, apasionado por la arquitectura de software, el procesamiento de datos y el desarrollo de soluciones escalables.
- 🛠️ Especializado en **desarrollo full stack**, diseño e integración de **APIs RESTful**, automatización de tareas y gestión avanzada de **bases de datos**.
- 📊 Experiencia en **análisis de datos, limpieza de datasets (ETL) y Web Scraping** para la extracción e integración de información.
- 🤖 Integración y manejo de **herramientas e Inteligencias Artificiales** aplicadas al desarrollo de software y optimización de flujos de trabajo.
- 💡 Enfocado en aplicar buenas prácticas (Clean Code), contenerización de aplicaciones y aprendizaje continuo.
...
<p>
  ...
  <img src="https://img.shields.io/badge/AI_Tools-00A67E?style=for-the-badge&logo=openai&logoColor=white" alt="IA / AI Tools" />
